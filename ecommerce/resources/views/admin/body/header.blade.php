      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">	
			...
			<img class="avatar avatar-xxl avatar-bordered" id="showImage" src="{{ (!empty($adminData->profile_photo_path))?url('upload/admin_images/'.$adminData->profile_photo_path) : url('upload/no_image.jpg') }}" alt="User Avatar">
			</a>
